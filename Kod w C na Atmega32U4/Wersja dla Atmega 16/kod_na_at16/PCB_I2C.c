...
switch (TWSR)
{
	case 0x08: SerialPrint("A START condition has been  transmitted\n\r");
	break;
	case 0x10: SerialPrint("A repeated START conditionhas been transmitted\n\r");
	break;
	case 0x18: SerialPrint("SLA+W has been transmitted ACK has been received\n\r");
	break;
	case 0x20:  SerialPrint("SLA+W has been transmitted NOT ACK has been received\n\r");
	break;
	case 0x28:SerialPrint("Data byte has been transmitted;ACK has been received\n\r");
	break;
	case 0x30:  SerialPrint("Data byte has been transmitted NOT ACK has been received\n\r");
	break;
	case 0x38: SerialPrint("Arbitration lost in SLA+W ordata bytes\n\r");
	break;
